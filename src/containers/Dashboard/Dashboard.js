...
class Dashboard extends Component {
    ...
    htmlHandler = () => {
        let html =  ReactDOMServer.renderToStaticMarkup(<div className="container">
        {this.state.rows.map((row,index) => <Row key={index} columns={row} elements={this.state.elements} />)}
        </div>)
