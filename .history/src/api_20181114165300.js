...
export const websiteStructure = (structure, token) => axios.post(apiUrl + 'website-structure', structure, headers(token));
...
export const createWebsite = (webSite, token) => axios.put(apiUrl + 'website', webSite, headers(token))
